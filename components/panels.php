					...
					<div class="container-fluid">
						...
						<ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
									...
									<li>
										<div class="message-notif-scroll scrollbar-outer">
											<div class="notif-center">
												<a href="#">
													<div class="notif-img"> 
														<img src="../assets/img/jm_denis.jpg" alt="Img index">
													</div>
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="../assets/img/chadengle.jpg" alt="Img index">
													</div>
													<div class="notif-content">
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="../assets/img/mlane.jpg" alt="Img index">
													</div>
													<div class="notif-content">
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="../assets/img/talha.jpg" alt="Img index">
													</div>
													<div class="notif-content">
									...
									<li>
										<div class="notif-scroll scrollbar-outer">
											<div class="notif-center">
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="../assets/img/index2.jpg" alt="Img index">
													</div>
													<div class="notif-content">
														<span class="block">
							...
							<li class="nav-item topbar-user dropdown hidden-caret">
								<a class="dropdown-toggle index-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
									<div class="avatar-sm">
										<img src="../assets/img/index.jpg" alt="..." class="avatar-img rounded-circle">
									</div>
									<span class="index-username">
								...
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<div class="dropdown-user-scroll scrollbar-outer">
										<li>
											<div class="user-box">
												<div class="avatar-lg"><img src="../assets/img/index.jpg" alt="image index" class="avatar-img rounded"></div>
												<div class="u-text">
													<h4>Hizrian</h4>
													<p class="text-muted">hello@example.com</p><a href="index.php" class="btn btn-xs btn-secondary btn-sm">View index</a>
												</div>
											</div>
										</li>
										<li>
											<div class="dropdown-divider"></div>
											<a class="dropdown-item" href="#">My index</a>
							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" id="pills-index-tab" data-bs-toggle="pill" href="#pills-index" role="tab" aria-controls="pills-index" aria-selected="false">index</a>
										</li>
										<li class="nav-item">
									...
									<div class="row">
										<div class="col-5 col-md-4">
											<div class="nav flex-column nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
												...
												<a class="nav-link" id="v-pills-index-tab" data-bs-toggle="pill" href="#v-pills-index" role="tab" aria-controls="v-pills-index" aria-selected="false">index</a>
										...
										<div class="col-7 col-md-8">
											<div class="tab-content" id="v-pills-tabContent">
												...
												<div class="tab-pane fade" id="v-pills-index" role="tabpanel" aria-labelledby="v-pills-index-tab">
													<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
													<p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way.
													</p>
												</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" id="pills-index-tab-nobd" data-bs-toggle="pill" href="#pills-index-nobd" role="tab" aria-controls="pills-index-nobd" aria-selected="false">index</a>
										</li>
										<li class="nav-item">
									...
									<div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
										...
										<div class="tab-pane fade" id="pills-index-nobd" role="tabpanel" aria-labelledby="pills-index-tab-nobd">
											<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
											<p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way.
											</p>
										</div>
									...
									<div class="row">
										<div class="col-5 col-md-4">
											<div class="nav flex-column nav-pills nav-secondary nav-pills-no-bd" id="v-pills-tab-without-border" role="tablist" aria-orientation="vertical">
												...
												<a class="nav-link" id="v-pills-index-tab-nobd" data-bs-toggle="pill" href="#v-pills-index-nobd" role="tab" aria-controls="v-pills-index-nobd" aria-selected="false">index</a>
										...
										<div class="col-7 col-md-8">
											<div class="tab-content" id="v-pills-without-border-tabContent">
												...
												<div class="tab-pane fade" id="v-pills-index-nobd" role="tabpanel" aria-labelledby="v-pills-index-tab-nobd">
													<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
													<p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way.
													</p>
												</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons justify-content-center" id="pills-tab-with-icon" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" id="pills-index-tab-icon" data-bs-toggle="pill" href="#pills-index-icon" role="tab" aria-controls="pills-index-icon" aria-selected="false">
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-index-icon" role="tabpanel" aria-labelledby="pills-index-tab-icon">
											<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
											<p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way.
											</p>
										</div>
									...
									<div class="row">
										<div class="col-5 col-md-4">
											<div class="nav flex-column nav-pills nav-secondary nav-pills-no-bd nav-pills-icons" id="v-pills-tab-with-icon" role="tablist" aria-orientation="vertical">
												...
												<a class="nav-link" id="v-pills-index-tab-icons" data-bs-toggle="pill" href="#v-pills-index-icons" role="tab" aria-controls="v-pills-index-icons" aria-selected="false">
													<i class="far fa-user"></i>
													index
												</a>
											</div>
										...
										<div class="col-7 col-md-8">
											<div class="tab-content" id="v-pills-with-icon-tabContent">
												...
												<div class="tab-pane fade" id="v-pills-index-icons" role="tabpanel" aria-labelledby="v-pills-index-tab-icons">
													<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
													<p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way.
													</p>
												</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav nav-tabs nav-line nav-color-secondary" id="line-tab" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" id="line-index-tab" data-bs-toggle="pill" href="#line-index" role="tab" aria-controls="pills-index" aria-selected="false">index</a>
										</li>
										<li class="nav-item">
									...
									<div class="tab-content mt-3 mb-3" id="line-tabContent">
										...
										<div class="tab-pane fade" id="line-index" role="tabpanel" aria-labelledby="line-index-tab">
											<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
